...
public class Resource {
    ...
    public static final String CHAT_HOME = "//node[contains(@text, '微信')]";
    // 点击类
    ...
    public static final String WECHAT_CONTACTS = "(//node[@resource-id='com.tencent.mm:id/d9a'])[2]";
    //    public static final String WECHAT_FINDS = "(//node[@resource-id='com.tencent.mm:id/d9a'])[3]";
    ...
    public static final String XCX_SEARCH_BUTTON = "//node[@resource-id='com.tencent.mm:id/kj']";
    public static final String XCX_TEXT_FIELD = "//node[@resource-id='com.tencent.mm:id/ami']";
    public static final String XCX_MORE = "//node[@resource-id='com.tencent.mm:id/amo']";
